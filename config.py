...
class Config(object):
    # Bot Information 
    TECH_VJ_BOT_TOKEN = os.environ.get("TECH_VJ_BOT_TOKEN", "6959002547:AAH1lmTe_EYSe97G6uElFenjsxh9JMyaq_w")
    TECH_VJ_BOT_USERNAME = os.environ.get("TECH_VJ_BOT_USERNAME", "Kcjgjdjfhgg_bot") # Bot username without @.
